...
export default rc<ComponentPropsWithoutRef<"svg"> & { id: string }>(
  ({ id, style, ...props }) => (
    <svg
      width="2560"
      height="1920"
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.0833333" stopColor="#ddb896" />
          <stop offset="0.364583" stopColor="#efddcc" />
          <stop offset="0.658041" stopColor="#FFFFFF00" />
          <stop offset="0.798521" stopColor="#ad7f58" />
          <stop offset="0.942708" stopColor="#FFFFFF00" />
        ...
        >
          <stop stopColor="#FFFFFF00" />
          <stop offset="0.0833333" stopColor="#fcf9f6" />
          <stop offset="0.333803" stopColor="#fefdfc" />
          <stop offset="0.658041" stopColor="#FFFFFF00" />
          <stop offset="0.798521" stopColor="#ad7f58" />
          <stop offset="0.942708" stopColor="#FFFFFF00" />
          <stop offset="1" stopColor="#FFFFFF00" />
        ...
        >
          <stop stopColor="#FFFFFF00" />
          <stop offset="0.140625" stopColor="#f8f1ea" />
          <stop offset="0.333803" stopColor="#ddb896" />
          <stop offset="0.658041" stopColor="#FFFFFF00" />
          <stop offset="0.798521" stopColor="#ad7f58" />
          <stop offset="0.942708" stopColor="#FFFFFF00" />
          <stop offset="1" stopColor="#FFFFFF00" />
